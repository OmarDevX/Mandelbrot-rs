...
use sdl2::{event::WindowEvent, keyboard::Keycode, mouse::MouseWheelDirection, sys::u_int};
...
fn main() {
    ...
    'running: loop {
        ...
        unsafe {
            ...
            let zoom_loc = gl::GetUniformLocation(compute_shader_program, CString::new("zoom").unwrap().as_ptr());
            let offset_loc = gl::GetUniformLocation(compute_shader_program, CString::new("offset").unwrap().as_ptr());

            gl::Uniform1f(time_loc as GLint, timer);
            gl::Uniform1f(zoom_loc as GLint, main_window.sandbox_window.zoom);
            gl::Uniform2f(offset_loc as GLint, main_window.sandbox_window.offset.0,main_window.sandbox_window.offset.1);
        ...
        for event in event_pump.poll_iter() {
            match event {
                ...
                Event::KeyDown {
                    ...
                    Keycode::W => main_window.sandbox_window.offset.1 += main_window.sandbox_window.move_speed * main_window.sandbox_window.zoom,
                    Keycode::S => main_window.sandbox_window.offset.1 -= main_window.sandbox_window.move_speed * main_window.sandbox_window.zoom,
                    Keycode::A => main_window.sandbox_window.offset.0 -= main_window.sandbox_window.move_speed * main_window.sandbox_window.zoom,
                    Keycode::D => main_window.sandbox_window.offset.0 += main_window.sandbox_window.move_speed * main_window.sandbox_window.zoom,
                    _ => {}
                },
                Event::MouseWheel { y, direction, .. } => {
                    match direction {
                        MouseWheelDirection::Normal => {
                            main_window.sandbox_window.zoom /= 1.0 + 0.1 * (y as f32);
                        }
